...
from .models import Teacher, Student, Subject, Schedule
...
class ScheduleViewSetTest(APITestCase):
    ...
    def setUp(self):
        ...
        self.teacher = Teacher.objects.create(user_name="teacher1", human_name="John Doe", password="password123", subject=self.subject)
        self.student = Student.objects.create(user_name="student1", human_name="Jane Doe", password="password123")
    ...
    def test_create_schedule_without_permission(self):
        another_teacher = Teacher.objects.create(user_name="teacher2", human_name="Alice", password="password123", subject=self.subject)
        data = {
